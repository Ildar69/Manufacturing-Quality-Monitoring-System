...
*[Подробнее про сбор данных →](01-paint-shop-data-collection.md).*
*Следующий блок: [аналитика — дашборды реального времени, глубокая аналитика по запросу, система алертов](01-paint-shop-data-collection.md).*
